    ...
    <div className="bg-semiTransparent rounded-3xl shadow-custom overflow-hidden p-6 px-4 mx-auto max-w-full sm:max-w-4xl w-full sm:m-8">
      <div className="flex flex-col sm:flex-row sm:space-x-6 sm:space-y-0 space-y-4 sm:items-center">
        <input
          ...
          className="px-4 py-2 rounded-md w-full sm:w-[calc(33.33%-1.5rem)] text-black text-opacity-70 placeholder-black placeholder-opacity-50 bg-lightBrown border-none font-poppins focus:outline-none focus:ring-1 focus:ring-darkBrowny"
          value={searchKeyword}
        ...
        <input
          ...
          className="px-4 py-2 rounded-md w-full sm:w-[calc(33.33%-1.5rem)] text-black text-opacity-70 placeholder-black placeholder-opacity-50 bg-lightBrown border-none focus:outline-none focus:ring-1 focus:ring-darkBrowny"
          value={location}
